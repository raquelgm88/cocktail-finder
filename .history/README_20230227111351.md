...
Si quieremos buscar otra bebida podemos clickar en el botón "Reset" para borrar el campo de búsqueda, o directamente borrar manualmente lo que tengamos escrito y realizar una nueva búsqueda.
